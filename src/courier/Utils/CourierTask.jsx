            ...
            <li key={task._id} className="p-2 border rounded flex justify-between items-center">
              <div>
                ...
                <div className="flex mt-4">
                  <div><FaCalendarAlt className="text-gray-500" /></div>
                  <p className="text-sm text-gray-600"> {new Date(task.time).toLocaleString()}</p>
                </div>
              </div>
        ...
        <div className="mb-4">
          ...
          {isEditing ? (
            ...
            <button
              ...
              className="bg-[#1F2937] text-white p-2 rounded w-full mt-2 hover:bg-[#1F2923]"
            >
              Add Task
            </button>
          )}
