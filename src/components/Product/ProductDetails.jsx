...
//   AiOutlineMessage,
// } from "react-icons/ai";
// import { FaBoxOpen, FaCity, FaClipboardList, FaLocationArrow, FaStar } from "react-icons/fa";
// import { Link, useNavigate } from "react-router-dom";
// import CommentManager from "../../pages/CommentManager";
// import StrikeLine from "../Utilities/StrikeLine";
...
//   const userHasOrdered = userProfile?.order.some(orderTable =>
//     product?.order.some(productOrder => productOrder === orderTable)
//   );
...
//       <Link className="text-yellow-500 text-2xl mb-2 flex items-center" to={`/seller/${sellerId}`}>
//         <AiOutlineShop className="mr-2" /> Visit Store
//       </Link>

//       <div className={`text-lg font-bold flex items-center ${rating >= 4 ? "text-green-500" : "text-yellow-500"}`}>
//         <FaStar className="mr-2" /> Rating: {rating} ★
//       </div>
...
//         {isDescriptionVisible ? description : descriptionPreview}
//         {description?.length > 100 && (
//           <button className="text-blue-500 ml-2 flex items-center" onClick={toggleDescription}>
//             {isExpanded ? (
//               <>
//                 See Less <AiOutlineUp className="ml-1" />
//               </>
...
//         {userProfile ? (
//           userHasOrdered ? (
//             <button className="flex items-center text-blue-500" onClick={handleMessageSeller}>
//               <AiOutlineMessage className="mr-2" />
//               Message to Seller
//             </button>
//           ) : (
//             <div className="text-red-500">You must purchase this product to leave a review.</div>
//           )
//         ) : (
//           <div className="flex items-center">
//             <Link to={'/user/login'} className="flex items-center text-[#0d9488] underline">
