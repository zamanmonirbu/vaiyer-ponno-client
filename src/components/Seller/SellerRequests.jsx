...
import { fetchDeactivatedSellers, deleteSeller, updateSeller } from '../../actions/sellerActions';

const SellerRequests = () => {
  const dispatch = useDispatch();
  const { deactivatedSellers, loading, error } = useSelector((state) => state.seller);
  useEffect(() => {
