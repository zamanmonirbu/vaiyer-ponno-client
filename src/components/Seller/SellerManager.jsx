...
const SellerManager = () => {
  ...
  const { sellers, seller, loading, error } = useSelector((state) => state.seller);
          ...
          <tbody>
            {sellers.map((seller, index) => (
              <tr key={seller._id} className="border-b border-gray-300">
                ...
                <td className="p-2 border border-gray-300 text-center">{seller.name}</td>
                <td className="p-2 border border-gray-300 text-center">{seller.email}</td>
                <td className="p-2 border border-gray-300 text-center">
                  <button
        ...
        <div className="mt-6">
          {updateMode ? (
            ...
            <div>
              ...
              <img src={sellerImg} alt={sellerName} className="w-48 h-48 object-cover mb-2 rounded" />
