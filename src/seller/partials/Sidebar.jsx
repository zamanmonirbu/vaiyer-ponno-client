...
function Sidebar({ sidebarOpen, setSidebarOpen, variant = "default" }) {
  ...
  const sellerAuth = JSON.parse(localStorage.getItem("sellerAuth"));
  // const { city, road, postalCode } = useSelector((state) => state.location);
  // console.log(city, road, postalCode);

  const { seller} = useSelector((state) => state.seller);

  useEffect(() => {
    dispatch(fetchSellerById(sellerAuth?.id));
  }, [dispatch, sellerAuth?.id]);
  ...
  // console.log("sidebar",seller.location);
// 
  return (
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink className="block p-4 bg-white rounded-lg shadow hover:bg-gray-100 transition duration-200">
           
            <p>{seller?.location?.city || "No address provided"}</p>
          </NavLink>
        </div>
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/seller/dashboard dark:hover:text-gray-200 transition duration-150 truncate"
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Sign in
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/seller/dashboard hover:text-gray-700 dark:hover:text-gray-200 transition duration-150 truncate"
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Reset Password
                              </span>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/seller/dashboard hover:text-gray-700 dark:hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Step 1
                              </span>
                            </NavLink>
