...
function Sidebar({ sidebarOpen, setSidebarOpen, variant = "default", seller }) {
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    {/* Profile Icon */}
                    <svg
                      className={`shrink-0 h-6 w-6 ${pathname.includes("profile") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li>
                            <button
                              ...
                              className="flex items-center gap-3.5 px-6 py-4 font-medium duration-300 ease-in-out hover:text-primary lg:text-base "
                            >
                              {/* Logout SVG */}
                              Log Out
                            </button>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/seller/dashboard/test hover:text-gray-700 dark:hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Step 1
                              </span>
                            </NavLink>
