        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={seller.img} alt="profile" />
              <label
                htmlFor="profile"
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180 mt-16">
              <h4 className="font-semibold text-black dark:text-white text-left">
                About Me
              </h4>
              <p className="mt-4.5">
                I am Moniruzzaman. I am full stack MERN developer. I like code solve problem of our daily life.  
              </p>
            </div>
