...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      ...
      <NavLink
      to="/admin/dashboard"
      className="flex items-center gap-8 text-white rounded-md hover:bg-gray-200 transition duration-300 ease-in-out mx-8"
    >
      <FaUserShield className="text-white text-3xl" /> 
      <span className="text-bodydark1 font-medium">Admin</span>
    </NavLink>
        <button
          ref={trigger}
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/admin/dashboard' || pathname.includes('dashboard')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/admin/seller' || pathname.includes('seller')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                       <MdOutlineMonitor     className="text-bodydark1" /> 
                       Manage UI
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                      ...
                      >
                        ...
                        <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 text-gray-300">
                              Notification
                              </span>
                            </NavLink>
                          </li>
                        <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/manage/gallery"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                              }
                            >
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                       <FaStore className="text-bodydark1" /> 
                       Sellers
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/admin/dashboard/view/seller"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/admin/dashboard/request/seller"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/admin/person' || pathname.includes('person')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <FaUserShield className="text-bodydark1" /> 
                       Admin
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/admin/dashboard/request/admin"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <button onClick={handleLogout} className='text-black ml-4 bg-white rounded-2xl p-2'>
                              Log Out
                            </button>
                          </li>
                          {/* <li>
